...
| **N6** | 직원·임원·최대주주·감사의견 | DART DS002 | **83,700 설계·완료** | 인적자본, 지배구조. 부실 신호는 final-vintage로 보류 |
...
> **2026-08-27 완료.** 누적 응답·3개년 응답·`executive` 제외로 요청 설계를 83,700건으로
> 줄였고 2015~2025 raw를 백필했다. 전체 횡단면 분석에서
> `hc_employee_growth_yoy`·`hc_revenue_per_employee`·`own_major_stake` level/change만
> Horizon Scan 후보로 남겼다. 감사의견과 최대주주 변경은 final-vintage·availability 문제로
> `NE`다. → [`poc/n6_analysis_20260827.md`](poc/n6_analysis_20260827.md)
...
3차
├─ N6 직원·임원·최대주주·감사의견 (DART DS002) ← 완료 · 4개 후보 선택     → 07
